...
tags: ['react']
draft: false
summary: state 到底是同步还是异步的？
---

在不同的执行环境下，或者不同的 React 模式下，State 更新流程都是不同的。
...
#### Q: 假如一次事件中触发一次如上 setState ，在 React 底层主要做了那些事呢？
...
![3.2.jpg](http://blog.minouccc.online:9000/blog/react_3.2.png)
...
![3.3.jpg](http://blog.minouccc.online:9000/blog/react_3.3.png)
